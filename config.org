...
* File Management
#+begin_src elisp
(setq emacs-private-dir (concat (getenv "HOME") "/.emacs.d/configs/vanilla-emacs/"))
...
;; TODO add jump to function/class definitions etc
(my/leader-keys
 "j"   '(:ignore t :which-key "jump")
 "jj"  '(avy-goto-char :which-key "jump to char")
 "jw"  '(avy-goto-word-0 :which-key "jump to word")
